  ...
  let colorWrapperArray = ["#221712", "#003fac", "#ba1200" ]
   {
    ...
    btnarrow.onclick = function(){
      for (let i = 0; i < changedBlock.length; i++){
        ...
        let chessCover = document.querySelector('.chess_game')
        ...
        let silentCover = document.querySelector('.silent_lamb')
        silentCover.style.background = 'rgb(0, 63, 172)'
        let drakCover = document.querySelector('.drak')
        drakCover.style.background = 'rgb(34, 23, 28)'
        let shineCover = document.querySelector('.shine_wrap')
        shineCover.style.background = 'rgb(249, 244, 255)'
        let ladyCover = document.querySelector('.mackbet')
        ladyCover.style.background = 'rgb(34, 23, 28)'
        let birdCover = document.querySelector('.cuckoo')
        birdCover.style.background = 'rgb(0, 63, 172)'
        let warCover = document.querySelector('.war_peace')
        warCover.style.background = 'rgb(0, 63, 172)'
        let numbCover = document.querySelector('.number')
        numbCover.style.background = 'rgb(186, 18, 0)'
        let storyCover = document.querySelector('.storytell')
        storyCover.style.background = 'rgb(186, 18, 0)'
        let cattleCover = document.querySelector('.animal')
        cattleCover.style.background = 'rgb(0, 63, 172)'
        let coverArray = {
          ...
          silentCover: 'rgb(0, 63, 172)',
          drakCover: 'rgb(34, 23, 28)',
          shineCover: 'rgb(249, 244, 255)',
          ladyCover:'rgb(34, 23, 28)',
          birdCover: 'rgb(0, 63, 172)',
          warCover: 'rgb(0, 63, 172)',
          numbCover: 'rgb(186, 18, 0)',
          storyCover: 'rgb(186, 18, 0)',
          cattleCover:'rgb(0, 63, 172)'
        }
